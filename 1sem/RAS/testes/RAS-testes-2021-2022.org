...
- Um co-autores deve conseguir submeter dados relativos a um artigo. (req. utilizador)
...
- O ficheiro que contêm o artigo científico tem um limite máximo de 35MB. (req. de sistema)
...
São todos requisitos nao funcionais

- O sistema deve poder ser utilizado por um utilizador sem experiência, em menos de 15 mins. (req. sistema)

- O sistema tem que ter capacidada para ser acedido por 50 utilizadores ao mesmo tempo (req sistema)
